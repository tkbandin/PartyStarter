...
.spread(function(joe, sue) {
  ...
  var bonfire   = new Party({ name: 'Bonfire', 'time.start': '12', 'time.end': '5', date: '9/20/16' , address: '321 some avenue', description: 'another party!', 'foodList.chosen': false, 'playlist.chosen': false, 'entertainment.chosen': false, organizer: joe._id });
...
.then(function(savedParties) {
  ...
  return Party.find({}).populate('user');
})
